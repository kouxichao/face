...
// ----------------------------------------------------------------------------------------
    ...
    )
    {
        ...
        if (det.num_parts() == 5)
        {
            ...
            dpoint p0(0.8695674595992, 0.4598339285714);
            dpoint p1(0.6565339285714, 0.4615741071428);
            dpoint p2(0.1305750620789, 0.4598339285714);
            dpoint p3(0.3419160714285, 0.4615741071428);
            dpoint p4(0.5002250000000, 0.7205053571428);
